Files "kymogram_omega-turn.npy" and "kymogram_delta-turn.npy" were generated from experimental data of [1]. The procedure for creating the kymograms can be found in [2].
